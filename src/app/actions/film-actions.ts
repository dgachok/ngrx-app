...
export const ADD_COMMENT_SUCCESS_ACTION = 'ADD_COMMENT_SUCCESS_ACTION';
export const REMOVE_COMMENT_SUCCESS_ACTION = 'REMOVE_COMMENT_SUCCESS_ACTION';
...
export const removeCommentSuccess = (comment) => ({
  type: REMOVE_COMMENT_SUCCESS_ACTION,
  payload: comment
});
