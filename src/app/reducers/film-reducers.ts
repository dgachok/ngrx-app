...
export const selectedFilm = (state) => state.films.filter(film => film.id === state.selectedFilmId)[0];
...
const selectedFilmId = (state, action) => {
  switch (action.type) {
...
export const reducers = {films, selectedFilmId};
